...
goog.exportSymbol('proto.towns.GetRoomListRequest.AuthTokenCheckerCase', null, global);
...
proto.towns.GetRoomListRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.towns.GetRoomListRequest.oneofGroups_);
};
...
proto.towns.GetRoomListResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.towns.GetRoomListResponse.repeatedFields_, null);
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.towns.GetRoomListResponse.displayName = 'proto.towns.GetRoomListResponse';
}
...
proto.towns.GetRoomListRequest.prototype.getAuthTokenCheckerCase = function() {
  return /** @type {proto.towns.GetRoomListRequest.AuthTokenCheckerCase} */(jspb.Message.computeOneofCase(this, proto.towns.GetRoomListRequest.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.towns.GetRoomListRequest.prototype.toObject = function(opt_includeInstance) {
...
proto.towns.GetRoomListRequest.deserializeBinary = function(bytes) {
  ...
  return proto.towns.GetRoomListRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.towns.GetRoomListRequest}
 */
proto.towns.GetRoomListRequest.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.towns.GetRoomListRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
proto.towns.GetRoomListRequest.prototype.setAuthToken = function(value) {
  return jspb.Message.setOneofField(this, 1, proto.towns.GetRoomListRequest.oneofGroups_[0], value);
};
...
proto.towns.GetRoomListRequest.prototype.clearAuthToken = function() {
  return jspb.Message.setOneofField(this, 1, proto.towns.GetRoomListRequest.oneofGroups_[0], undefined);
};
 ...
 * @return {!Object}
 */
proto.towns.GetRoomListResponse.prototype.toObject = function(opt_includeInstance) {
...
proto.towns.GetRoomListResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.towns.RoomInfo.toObject, includeInstance)
  };
...
proto.towns.GetRoomListResponse.deserializeBinary = function(bytes) {
  ...
  return proto.towns.GetRoomListResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.towns.GetRoomListResponse}
 */
proto.towns.GetRoomListResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      reader.readMessage(value,proto.towns.RoomInfo.deserializeBinaryFromReader);
      msg.addRooms(value);
      break;
    default:
      reader.skipField();
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.towns.GetRoomListResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!proto.towns.RoomInfo}
 */
proto.towns.GetRoomListResponse.prototype.addRooms = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.towns.RoomInfo, opt_index);
};
